  ...
  try {
    ...
    if (existingPatient) {
      ...
      await sequelize.query(`
        CALL procedure_to_register_patient_record(:full_name, :address, :gender, :age, :emergency_contact, :emergency_phone, :hypertension, :hypertension_control, :diabetes, :diabetes_control, :hospitalization, :allergy_medication, :bleeding, :serious_illness, :pregnancy, :pregnancy_months, :recent_food, :recent_symptoms, :blood_pressure, :blood_sugar, :last_treatment, :other_physical_data, :treatment, :cost, :treatment_date, :tooth_number, :conductometry, :restoration, :other_root_canal_data)`, {
        replacements: {
          full_name, address, gender, age, emergency_contact, emergency_phone, hypertension, hypertension_control,
          diabetes, diabetes_control, hospitalization, allergy_medication, bleeding, serious_illness, pregnancy,
          pregnancy_months, recent_food, recent_symptoms, blood_pressure, blood_sugar, last_treatment,
